...
const (
	...
	ES_URL = "http://104.154.193.127:9200"
...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	user := r.Context().Value("user") //user is a jwt token
	...
	// Client side needs to know the media type so as to render it.
